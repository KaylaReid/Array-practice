 const customers = [
    ...
    let storedEmails = [];
    const extractEmail = customers.map(function(index){
        return storedEmails = storedEmails.concat(index.contacts.email)
...
// function getEmails(arg){
//     let custEmails = [];
//     for(i = 0; i < arg.length; i++){
//     let emails = arg[i].contacts.email
//     custEmails.push(emails);
//     }
//     return allEmails = custEmails.concat()
// }
// console.log(getEmails(customers));

// let spam = document.querySelector(".spam")
// spam.innerHTML = `<h1>${getEmails(customers).join(" ")}</h1>`
